...
const page = () => {
  return (
    ...
    {/* Apple Liquid Glass Card Components */}
    <div style={{ 
      display: 'grid', 
      ...
      <div className="liquidGlass-wrapper liquidGlass-surface" style={{ 
        padding: '2rem', 
        borderRadius: '16px',
        minHeight: '200px',
        display: 'flex',
        ...
        <div className="liquidGlass-text">
          ...
          <p style={{ margin: '0 0 1.5rem 0', opacity: '0.9', lineHeight: '1.5' }}>
            classNameic Apple design with top-left edge refraction creating the signature liquid effect.
          </p>
          <div style={{ 
            fontSize: '0.875rem',
            opacity: '0.7',
            ...
            Default: top-left refraction
          </div>
        </div>
      </div>

      {/* Top-Right Edge Refraction */}
      <div className="liquidGlass-wrapper liquidGlass-surface top-right-refraction" style={{ 
        padding: '2rem', 
        borderRadius: '16px',
        minHeight: '200px',
        display: 'flex',
        ...
        <div className="liquidGlass-text">
          <h3 style={{ margin: '0 0 1rem 0', fontSize: '1.5rem', fontWeight: '600' }}>
            Top-Right Refraction
          </h3>
          <p style={{ margin: '0 0 1.5rem 0', opacity: '0.9', lineHeight: '1.5' }}>
            Liquid glass with top-right edge highlighting for different layouts.
          </p>
          <div style={{ 
            fontSize: '0.875rem',
            opacity: '0.7',
      ...
      <div className="liquidGlass-wrapper liquidGlass-surface bottom-left-refraction" style={{ 
        padding: '2rem', 
        borderRadius: '16px',
        minHeight: '200px',
        display: 'flex',
        ...
        <div className="liquidGlass-text">
          <h3 style={{ margin: '0 0 1rem 0', fontSize: '1.5rem', fontWeight: '600' }}>
            Bottom-Left Refraction
          </h3>
          <p style={{ margin: '0 0 1.5rem 0', opacity: '0.9', lineHeight: '1.5' }}>
            Alternative refraction from bottom-left edges for unique visual hierarchy.
          </p>
          <div style={{ 
            fontSize: '0.875rem',
            opacity: '0.7',
      ...
      {/* All Edges (Subtle Glow) */}
      <div className="liquidGlass-wrapper liquidGlass-surface all-edges" style={{ 
        padding: '2rem', 
        borderRadius: '16px',
        minHeight: '200px',
        display: 'flex',
        ...
        <div className="liquidGlass-text">
          ...
          <p style={{ margin: '0 0 1.5rem 0', opacity: '0.9', lineHeight: '1.5' }}>
            Uniform edge lighting for balanced compositions and central focus.
          </p>
          <div style={{ 
            fontSize: '0.875rem',
            opacity: '0.7',
      ...
      <div className="liquidGlass-wrapper liquidGlass-surface" style={{ 
        ...
        <div className="liquidGlass-text">
          <div>
            <h3 style={{ margin: '0 0 1rem 0', fontSize: '1.75rem', fontWeight: '600' }}>
              Configurable Edge Refraction
            </h3>
            <p style={{ margin: '0 0 2rem 0', opacity: '0.9', lineHeight: '1.6', fontSize: '1.1rem' }}>
              Apple's liquid glass effect achieved with authentic edge-specific light refraction. 
              Each variant focuses light on different edges, creating depth and dimensionality 
              just like real glass materials.
            </p>
          </div>
